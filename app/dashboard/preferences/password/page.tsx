        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            style={{
              ...
              background: twoFa ? 'var(--color-primary-emphasis)' : 'var(--color-border)', position: 'relative', transition: 'background 200ms',
            }}
          >
            <span style={{
      ...
      <div className="card">
        ...
        <div className="space-y-2">
          {sessions.map(session => (
            <div key={session.id} className="flex items-center justify-between rounded-lg px-4 py-3" style={{ background: session.current ? 'var(--color-primary-light)' : 'var(--color-surface)', border: `1px solid ${session.current ? 'var(--color-accent-border)' : 'var(--color-border-subtle)'}` }}>
              <div className="flex items-center gap-3">
