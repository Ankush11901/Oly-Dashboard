...
export type UserCategory = 'all' | 'admin' | 'regular';
...
export const ROLE_DEFS: RoleDef[] = [
  { id: 'super_admin', name: 'Super Admin', description: 'Full unrestricted access to all modules', userType: 'admin' },
  { id: 'regional_director', name: 'Regional Director', description: 'Cross-store analytics & team oversight', userType: 'admin' },
  { id: 'store_manager', name: 'Store Manager', description: 'Full access to assigned store & team', userType: 'regular' },
  { id: 'security_ops', name: 'Security Ops', description: 'Live feed monitoring & incident management', userType: 'regular' },
  { id: 'staff', name: 'Staff Associate', description: 'Read-only dashboard & analytics access', userType: 'regular' },
];
...
export const DEFAULT_ROLE_PERMS: Record<string, Record<string, PermLevel>> = {
...
export const INITIAL_MEMBERS: Member[] = [
  { id: 1, name: 'Aditi Sharma', email: 'aditi.sharma@olyretail.com', phone: '+65 9123 4001', roleId: 'store_manager', userType: 'regular', location: 'Marina Bay Sands', storeAccess: ['Marina Bay Sands', 'Orchard Central'], status: 'Active', avatar: 'https://i.pravatar.cc/68?img=47' },
  { id: 2, name: 'Jason Lee', email: 'jason.lee@olyretail.com', phone: '+65 9123 4002', roleId: 'regional_director', userType: 'admin', location: 'Singapore HQ', storeAccess: ['Marina Bay Sands', 'VivoCity', 'Bugis Junction', 'Tampines Mall'], status: 'Active', avatar: 'https://i.pravatar.cc/68?img=12' },
  { id: 3, name: 'Sarah Chen', email: 'sarah.chen@olyretail.com', phone: '+65 9123 4003', roleId: 'staff', userType: 'regular', location: 'Orchard Central', storeAccess: ['Orchard Central'], status: 'On Leave', avatar: 'https://i.pravatar.cc/68?img=44' },
  { id: 4, name: 'Michael Tan', email: 'michael.tan@olyretail.com', phone: '+65 9123 4004', roleId: 'security_ops', userType: 'regular', location: 'VivoCity', storeAccess: ['VivoCity', 'Bugis Junction'], status: 'Active', avatar: 'https://i.pravatar.cc/68?img=15' },
  { id: 5, name: 'Priya Nair', email: 'priya.nair@olyretail.com', phone: '+65 9123 4005', roleId: 'super_admin', userType: 'admin', location: 'Singapore HQ', storeAccess: LOCATIONS, status: 'Active', avatar: 'https://i.pravatar.cc/68?img=49' },
  { id: 6, name: 'Naren Kumar', email: 'naren.kumar@olyretail.com', phone: '+65 9123 4006', roleId: 'store_manager', userType: 'regular', location: 'Northpoint City', storeAccess: ['Northpoint City', 'Causeway Point'], status: 'Active', avatar: 'https://i.pravatar.cc/68?img=33' },
  { id: 7, name: 'Sneha Reddy', email: 'sneha.reddy@olyretail.com', phone: '+65 9123 4007', roleId: 'store_manager', userType: 'regular', location: 'Jurong Point', storeAccess: ['Jurong Point', 'Tampines Mall'], status: 'Active', avatar: 'https://i.pravatar.cc/68?img=25' },
  { id: 8, name: 'Priya Ganesh', email: 'priya.ganesh@olyretail.com', phone: '+65 9123 4008', roleId: 'staff', userType: 'regular', location: 'Bugis Junction', storeAccess: ['Bugis Junction'], status: 'Inactive', avatar: 'https://i.pravatar.cc/68?img=32' },
];

export const INITIAL_GROUPS: TeamGroup[] = [
  { id: 1, name: 'North Admins', description: 'Admin users covering northern stores', memberIds: [2, 5, 6, 7], storeScope: 'Northpoint City' },
  ...
  { id: 4, name: 'South Admins', description: 'Regional admin coverage for south', memberIds: [2, 5, 4, 1], storeScope: 'Marina Bay Sands' },
...
export function groupMatchesSearch(group: TeamGroup, members: Member[], query: string): boolean {
  ...
  return group.memberIds.some(id => {
    ...
    return m && memberMatchesSearch(m, q);
  });
}
